...
function gera_busca($palavra)
{
  $palavra = trim($palavra);
	...
	$palavra = strtr($palavra, "áàãâéêíóôõúüçÁÀÃÂÉÊÍÓÔÕÚÜÇ", "aaaaeeiooouucAAAAEEIOOOUUC");
...
{
  $palavra = trim($palavra);
  $palavra = strtolower(preg_replace("[^a-zA-Z0-9-]", "", strtr($palavra, "áàãâéêíóôõúüçÁÀÃÂÉÊÍÓÔÕÚÜÇ ", "aaaaeeiooouucAAAAEEIOOOUUC-")));
